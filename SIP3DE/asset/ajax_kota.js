...
function ajaxkota(id){
    ajaxku = buatajax();
    var url= baseurl + "index.php/PasienBaru/getKota/"+id;
...
function ajaxkec(id){
    ajaxku = buatajax();
    var url= baseurl + "index.php/PasienBaru/getKecamatan/"+id;
...
function ajaxkel(id){
    ajaxku = buatajax();
    var url= baseurl + "index.php/PasienBaru/getKelurahan/"+id;
